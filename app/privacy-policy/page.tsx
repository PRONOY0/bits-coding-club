...
export default function PrivacyPolicy() {
    return (
        <div className="container mx-auto py-8 px-4 md:px-6 lg:px-8 max-w-4xl">
            ...
            <p className="text-sm text-muted-foreground mb-6">Last updated: March 15, 2025</p>
            ...
            <div className="prose prose-sm md:prose-base lg:prose-lg max-w-none">
                ...
                <ul className="list-disc pl-6 space-y-2 mt-4">
                    ...
                    <li>
                        <strong>Website</strong> refers to BITS Pilani Coding Club, accessible from{" "}
                        <Link href="https://bits-coding-club.vercel.app/" className="text-primary hover:underline">
                            https://bits-coding-club.vercel.app/
                        </Link>
                    </li>
                    <li>
                ...
                <h4 className="text-lg font-medium mt-5 mb-2">Tracking Technologies and Cookies</h4>
                <p>
                ...
                <h4 className="text-lg font-medium mt-5 mb-2">Business Transactions</h4>
                <p>
                ...
                <h4 className="text-lg font-medium mt-5 mb-2">Law enforcement</h4>
                <p>
                ...
                <h4 className="text-lg font-medium mt-5 mb-2">Other legal requirements</h4>
                ...
                <ul className="list-disc pl-6 space-y-2 mt-4">
                    <li>
                        By email:{" "}
                        <a href="mailto:codingclub@online.bits-pilani.ac.in" className="text-primary hover:underline">
